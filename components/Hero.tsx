      ...
      >
        <div className="container mx-auto min-h-full ">
          <div className=" flex flex-col xl:flex-row items-center justify-between xl:pt-2 xl:pb-3">
            <div className=" mx-15 text-center xl:text-left order-2 xl:order-0">
              <span className=" text-xl">
                Fullstack (MERN)Software Developer <br />
                Expertise inNest.js and Next.js
              </span>
              <h1 className="text-5xl xl:text-7xl mb-0 xl:mb-0 ">
                Hello I am <br />
                <span className="text-[#00ff99] ">Trevor Oduol</span>
              </h1>
              <p className="max-w-[600px] mb-1 xl:mb-2 xl:mt-2  text-white/80 text-xl  ">
              ...
              <div className="flex flex-col xl:flex-row items-center gap-8 xl:mt-5">
                <Link href="/MY_RESUME.pdf" download>
                  <Button
                    variant="outline"
                    size="lg"
                    className="uppercase  rounded-full flex items-center gap-2"
                  >
